log using temp/RW2021/replication/replication_logs/table_2_log.txt, replace text


use temp/RW2021/replication/data/main_amazon_sales.dta, clear 
...
estimates save "temp/RW2021/replication/estimates/daily_param", replace



estimates use "temp/RW2021/replication/estimates/daily_param"
outreg2 using "temp/RW2021/replication/results/table_2_causal_effects.tex", keep(L.lrank lpamzn lreview lR) label replace se
*********************
...
estimates save "temp/RW2021/replication/estimates/usreg", replace
estimates use  "temp/RW2021/replication/estimates/usreg"
outreg2 using temp/RW2021/replication/results/table_2_causal_effects.tex, keep (L1.lrank lpamzn lreview lR  dnytpost1_3 dnytpost6_3 dnytpost10_3 dnytpost1r_3 dnytpost6r_3 dnytpost10r_3 dothpost_3 dothpost10_3) label se
...
estimates save "temp/RW2021/replication/estimates/usregint", replace
estimates use "temp/RW2021/replication/estimates/usregint" 
outreg2 using temp/RW2021/replication/results/table_2_causal_effects.tex, ///
...
estimates save "temp/RW2021/replication/estimates/3coreg", replace
estimates use "temp/RW2021/replication/estimates/3coreg"
outreg2 using temp/RW2021/replication/results/table_2_causal_effects.tex, keep (L1.lrank lpamzn lreview lR dnytpost1_3 dnytpost6_3 dnytpost10_3 dnytpost1r_3 dnytpost6r_3 dnytpost10r_3 dothpost_3 dothpost10_3 ) label se
...
reghdfe lrank L1.lrank  lpamzn lreview lR  lrR  dnytpost1_* dnytpost6_* dnytpost10_* dothpost_* dothpost10_*  dnytpostpre_* dothpostpre_* dnytpost1r_* dnytpost6r_* dnytpost10r_* dnytpostprer_* epos* eneg*, absorb(canum) vce(robust)
 estimates save "temp/RW2021/replication/estimates/3coregint", replace
estimates use  "temp/RW2021/replication/estimates/3coregint"
outreg2 using temp/RW2021/replication/results/table_2_causal_effects.tex, keep (L1.lrank lpamzn lreview lR lrR lr2R dnytpost1_3 dnytpost6_3 dnytpost10_3 dnytpost1r_3 dnytpost6r_3 dnytpost10r_3 dothpost_3 dothpost10_3 ) label se
