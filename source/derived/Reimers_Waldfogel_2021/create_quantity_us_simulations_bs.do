use "temp/RW2021/replication/tempfiles/quantity_us_simulations.dta", clear 
	keep asin 
	tempfile asin
	save `asin'
...
cross using temp/RW2021/replication/data/sigma.dta 
...
save temp/RW2021/replication/tempfiles/quantity_us_simulations_bs_`k'.dta, replace
restore
}
