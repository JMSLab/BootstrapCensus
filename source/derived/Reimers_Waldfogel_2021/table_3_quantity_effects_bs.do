...
use "temp/RW2021/replication/data/A_B_params_bs.dta", clear
...
preserve
keep nyt1 nyt1r starmean
drop if _n > 500
save "temp/RW2021/table3_top_replicates.dta", replace
restore

log using temp/RW2021/replication/replication_logs/table_3_bs_log.txt, replace text 
...
set obs 1
gen x = .
save temp/RW2021/replication/tempfiles/table_3_ses.dta, replace

* the code reads files created in create_quantity_us_simulations_bs.do

forvalues k = 1(1) 500 { 
use temp/RW2021/replication/tempfiles/quantity_us_simulations_bs_`k'.dta, clear
...
append using temp/RW2021/replication/tempfiles/table_3_ses.dta
sleep 10
save temp/RW2021/replication/tempfiles/table_3_ses.dta, replace

}

use  temp/RW2021/replication/tempfiles/table_3_ses.dta, clear
...
preserve
keep nyt_not_rec_only
drop if _n > 500
save "temp/RW2021/table3_bottom_replicates.dta", replace
restore
