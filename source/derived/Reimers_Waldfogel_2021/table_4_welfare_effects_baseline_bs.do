...
set obs 1
gen x=.
save  "temp/RW2021/replication/tempfiles/welfare_effects_baseline_bs.dta", replace 
...
quietly{
	...
	** keep totals & save 
	...
	append using temp/RW2021/replication/tempfiles/welfare_effects_baseline_bs.dta 		
	save temp/RW2021/replication/tempfiles/welfare_effects_baseline_bs.dta, replace 
}	
}
...
use temp/RW2021/replication/tempfiles/welfare_effects_baseline_bs.dta, clear 
	drop if CS==.
* define variables
...
preserve
keep ratio dCS_reviews dCS_stars_adj
drop if _n > 500
save temp/RW2021/table4_replicates.dta, replace			
restore
		
log using temp/RW2021/replication/replication_logs/table_4_baseline_bs_log.txt, replace text 
